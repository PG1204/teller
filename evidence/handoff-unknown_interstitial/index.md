...
- **status**: `success`
- **mode**: replay  ·  **run**: `rep_2026-09-10T05-55-03_d126`  ·  **llm_invoked**: False
...
- **handoff**: `int_a7374b43` trigger `CHECKPOINT_FAILED` claimed by demo-operator → resume `retry_step` (6 human actions)
...
| s1 | human |  |  | 0 |  |
| s2 | ok | label_anchor | 0 | 161 | [s2_after.jpg](screenshots/s2_after.jpg) |
...
### handoff_live
![handoff_live](screenshots/handoff_live.jpg)
