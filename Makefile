.PHONY: install mock test unit integration schemas lint discover demo-replay replay-not-found replay-error replay-recovered handoff-demo evidence clean
...
replay-error:
	...
	$(TELLER) replay capabilities/ledgerline.member.read_savings_balance@1.0.0.yaml --tenant local --param member_id=10001 --unattended
